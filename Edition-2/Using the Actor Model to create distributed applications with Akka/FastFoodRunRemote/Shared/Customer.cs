...
namespace Shared
{
    public class Customer : TypedActor, IHandle<MarkHungry>, IHandle<Bill>
    {
        ...
        public void Handle(MarkHungry message)
        {
            ...
            IActorRef fastFoodEmployee = Context.ActorOf<FastFoodEmployee>("fastfoodemployee");
    ...
    public class Customer2 : UntypedActor
    {
        ...
        protected override void OnReceive(object message)
        {
            if (message is MarkHungry)
            {
                ...
                // IActorRef fastFoodEmployee = Context.ActorOf<FastFoodEmployee>("fastfoodemployee");
                // GET
                var fastFoodEmployee = Context.ActorSelection("akka.tcp://remotefastfood@localhost:8090/user/fastfoodemployee");
                //Context.Watch(fastFoodEmployee);
